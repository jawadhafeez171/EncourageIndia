...
const PcPage: React.FC = () => {
    return (
        <div className="bg-white dark:bg-slate-900 transition-colors duration-300">
            <SEO
                title="Karnataka Police Constable (PC) Exam Coaching | KSP Recruitment"
                description="Join our specialized PC coaching for Karnataka State Police recruitment. Comprehensive training for Physical Standard Test (PST) and written examination."
                url="https://encourageindiaias.in/courses/pc-exam"
            />
