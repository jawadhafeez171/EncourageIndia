...
const IbpsExamPage: React.FC = () => {
    return (
        <div className="bg-white dark:bg-slate-900 transition-colors duration-300">
            <SEO
                title="IBPS Banking Exam Coaching | PO, Clerk & Specialist Officer Prep"
                description="Comprehensive IBPS coaching for PO, Clerk, and Specialist Officer (SO) exams. Expert guidance for Prelims & Mains with dedicated banking awareness modules."
                url="https://encourageindiaias.in/courses/ibps-hub"
            />
