                        ...
                        <div>
                            ...
                            <div className="space-y-6 text-charcoal-gray dark:text-gray-200">
                                <div className="flex items-start space-x-4">
                                    <LocationPinIcon className="w-8 h-8 text-sunrise-orange mt-1 flex-shrink-0" />
                                    <div>
                                        <h3 className="font-semibold text-lg">Address</h3>
                                        <p>Near Al-ameen towers, Hosur Main Road, Lal Bagh Main Rd, Behind, Sudhama Nagar, Bengaluru, Karnataka 560027</p>
                                    </div>
                                </div>
                                <div className="flex items-start space-x-4">
                                    <PhoneIcon className="w-7 h-7 text-sunrise-orange mt-1 flex-shrink-0" />
                                    <div>
                                        <h3 className="font-semibold text-lg">Phone</h3>
                                        <div className="flex flex-col">
                                            <a href="tel:+919611621195" className="hover:text-sunrise-orange">+91 96116 21195</a>
                                            <a href="tel:+916364226477" className="hover:text-sunrise-orange">+91 63642 26477</a>
                                        </div>
                                    </div>
                                </div>
                                <div className="flex items-start space-x-4">
                            ...
                            <div className="mt-10">
                                <a href="https://maps.google.com" target="_blank" rel="noopener noreferrer">
                                    <img src="https://picsum.photos/seed/map/800/400" alt="Location map" className="rounded-lg shadow-md hover:shadow-xl transition-shadow w-full" />
                                </a>
                            </div>
                        </div>
