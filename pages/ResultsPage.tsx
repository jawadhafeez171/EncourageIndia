                ...
                <div className="container mx-auto px-8 max-w-7xl">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {achievers.map((achiever, idx) => (
                            <div key={idx} className="bg-white dark:bg-slate-800 rounded-3xl shadow-xl overflow-hidden text-center group transition-all duration-500 hover:-translate-y-2 border border-gray-100 dark:border-gray-700">
                                <div className="relative">
                                    <img src={achiever.photo} alt={achiever.name} className="w-full h-64 object-cover object-top filter grayscale group-hover:grayscale-0 transition-all duration-700" />
                ...
                <div className="container mx-auto px-8 max-w-6xl">
                    ...
                    <div className="grid md:grid-cols-1 lg:grid-cols-2 gap-10">
                        {mentors.map((mentor, idx) => (
                            <div key={idx} className="bg-white dark:bg-slate-900 p-10 rounded-[2.5rem] shadow-2xl text-left relative transition-all duration-300 border border-gray-100 dark:border-gray-700 group hover:border-empower-blue/30">
