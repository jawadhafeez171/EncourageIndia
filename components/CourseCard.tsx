  ...
  return (
    <div className="bg-white rounded-lg shadow-lg overflow-hidden flex flex-col h-full transform hover:-translate-y-2 transition-transform duration-300">
      ...
      <div className="p-6 flex flex-col flex-grow">
        <h3 className="font-montserrat text-xl font-bold text-empower-blue mb-2">{course.title}</h3>
        <p className="text-charcoal-gray/80 text-sm mb-4 flex-grow">{course.description}</p>
